    	...
    	do{
    		...
    		do{
    			...
    			switch (choice){
    				...
    				z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM SYARIAH-BOJONEGORO", JOptionPane.YES_NO_OPTION, 3); //konfirmasi lain
    				if (z==0)
    					break;
    				else

    					JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM SYARIAH-BOJONEGORO, ambil kartu ATM Anda.");
    				System.exit(0);
    				...
    				z=JOptionPane.showConfirmDialog(null, "Melanjutkan transaksi lain?", "ATM SYARIAH-BOJONEGORO", JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
    				if (z==0)
    					break;
    				...
    				z=JOptionPane.showConfirmDialog(null, "Melanjutkan transaksi lain?", "ATM BNI SYARIAH-BOJONEGORO", JOptionPane.YES_NO_OPTION, 3); //konformasi transaksi lain
